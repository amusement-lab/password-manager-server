...
describe('Testing password CRUD', () => {
  ...
  //   expect(res1.body.username).to.be.an('string')
  //   expect(res1.body.username).to.be.equal('www.web1.com')
  ...
  //   expect(res2.body.username).to.be.an('string')
  //   expect(res2.body.username).to.be.equal('www.web2.com')
  ...
  //   expect(res3.body.username).to.be.an('string')
  //   expect(res3.body.username).to.be.equal('www.web3.com')
  // })
  ...
  //   expect(resDetail.body.username).to.be.an('string')
  //   expect(resDetail.body.username).to.be.equal('www.web1Edit.com')
  // })
